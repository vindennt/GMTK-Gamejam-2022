...
onready var drop_target = get_node("/root/GMTK 2022/HLayout//DragColumns/TargetContainer")
onready var draggable_scene: PackedScene = preload("res://RollButton.tscn")
